 ...
 Ext.onReady(function(){
 	...
 	var emp1 = Ext.create("Employee",{id:1,name:"Raju",designation:"Developesssr"});
 	//console.log(emp1.getId()+"\t"+emp1.getName()+"\t"+emp1.getDesignation());
 	//emp1.printDetails();
 	var div1=Ext.get("test");
 	var htmlContent = "<br> Id:"+emp1.getId();
 	htmlContent =htmlContent+ "<br> Name:"+emp1.getName();
 	htmlContent = htmlContent+"<br> Designation:"+emp1.getDesignation();
 	alert("br");
